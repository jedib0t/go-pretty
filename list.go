...
//go:generate mockgen -source list.go -destination mocks/list_mocks.go
...
// ListWriter declares the interfaces implemented by List.
...
// NewListWriter initializes and returns a ListWriter.
