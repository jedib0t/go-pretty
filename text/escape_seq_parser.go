...
const (
	...
	// Internal encoding for 256-color codes
	// Foreground 256-color: 1000 + colorIndex (1000-1255)
	// Background 256-color: 2000 + colorIndex (2000-2255)
	escCode256FgBase = 1000
	escCode256BgBase = 2000
	escCode256Max    = 255
)
