...
func TestTable_Render_AutoMerge_WithSomeColumnsCompletelyMerged(t *testing.T) {
	rcAutoMerge := RowConfig{AutoMerge: true}

	t.Run("simple short header columns", func(t *testing.T) {
		tw := NewWriter()
		...
		tw.AppendFooter(Row{"", "", "", 7, 5, 4}, rcAutoMerge)
